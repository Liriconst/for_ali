        ...
        return (
            <div className={styles.pageHome}>
                ...
                <div className={styles.homeSales}>
                    <Button className={"homeButtonSales"} type={"primary"}>Посмотреть все акции</Button>
                </div>
                <span className={styles.homeNewProducts}>Новое на сайте:</span>
                        ...
                        <Button className={"homeProductButton"}>
                            <div className={styles.homeProductCard}>
                                ...
                                <div className={styles.homeProductInfo}>
                                    ...
                                    <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "flex-start"}}>
                                        <span>Вес/объём: 5000 мл</span>
                                        <span>Количество: 10 шт</span>
                                    </div>
                                    <span style={{display: "flex", height: "100%", alignItems: "flex-end"}}>Цена: 80 руб.</span>
                                </div>
                            </div>
                        </Button>
                    </div>
